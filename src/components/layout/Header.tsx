        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center gap-2">
              <div className="hidden md:flex">
                <span className="font-bold text-xl text-study-700">
                  exampaper
                </span>
                <span className="text-xl text-muted-foreground">.org</span>
              </div>
              <div className="md:hidden">
                <span className="font-bold text-sm text-study-700">
                  exampaper
                </span>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/">
              <Button
                variant="ghost"
                className="flex items-center text-gray-600 hover:text-blue-600 dark:text-gray-300"
              >
